...
def video_frm(hst, outpth, Cnt=[]):
    ...
    with writer.saving( fig3, os.path.join(outpth, 'pViews_' +str(mf)+'.mp4'), 200 ):
...
def video_dyn11(hst, frms, outpth, axLUT, Cnt):
    ...
    with writer.saving(fig1, os.path.join(outpth, 'pViews_dyn.mp4'), 100):
