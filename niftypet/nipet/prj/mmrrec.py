...
def osemone(datain, mumaps, hst, txLUT, axLUT, Cnt,
    ...
    for n in range(Sn):
        ...
        sinoTIdx[n,1:], s = get_subsets14(n,txLUT,Cnt)
        # sensitivity image
...
#             sct_time = time.time()
#             ssn, sssr, amsk = mmrsct.vsm(mumaps, mmrimg.convert2e7(img, Cnt), datain, hst, rsn, txLUT, axLUT, Cnt, prcntScl=0.1, emmsk=emmskS)
